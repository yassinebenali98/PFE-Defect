...
urlpatterns = [
    ...
    path('my_report/<int:engagement_id>/', views.my_report_view, name='my_report'),
    path('priority-pie-chart/<int:engagement_id>/', views.priority_pie_chart, name='priority_pie_chart'),
