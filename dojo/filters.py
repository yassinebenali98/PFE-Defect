...
class ApiFindingFilter(DojoFilter):
    ...
    class Meta:
        ...
        exclude = ['url', 'thread_id', 'notes', 'files',
                   'line', 'cve','senario','scenarioDeRisque']
...
class FindingFilter(FindingFilterWithTags):
    ...
    engagement = filters.CharFilter(field_name='test__engagement__name')
    test = filters.CharFilter(field_name='test__test_type__name')
...
class ReportFindingFilter(FindingFilterWithTags):
    ...
    class Meta:
        ...
        exclude = ['date', 'cwe', 'url', 'description', 'mitigation', 'impact',
                   ...
                   'jira_creation', 'jira_change', 'files','senario','scenarioDeRisque']
