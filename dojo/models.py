...
class Finding(models.Model):
    ...
    type = models.CharField(max_length=511,
                             verbose_name=_('Type'),
                             help_text=_("Type"))
    complexite = models.CharField(max_length=511,
                             verbose_name=_('complexite'),null=True, blank=True,
                             help_text=_("complexite"))
    priorite = models.CharField(max_length=511,
                             verbose_name=_('priorite'),null=True, blank=True,
                             help_text=_("priorite"))
    statut = models.CharField(max_length=511,
...
class FindingImage(models.Model):
    finding = models.ForeignKey(Finding , related_name='images', on_delete=models.CASCADE)
    title = models.CharField(max_length=255)
    image = models.FileField(upload_to=UniqueUploadNameProvider('uploaded_files'),blank=True, null=True)
    def __str__(self):
        return self.title
