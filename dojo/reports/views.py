...
from dojo.reports.widgets import AvantPropos, CoverPage, PageBreak, TableOfContents, WYSIWYGContent, FindingList, EndpointList, \
...
def generate_report(request, obj, host_view=False):
    ...
    if type(obj).__name__ == "Product_Type":
        ...
        # Convert dictionary to JSON
        severitiesjson = json.dumps(severities_count)
